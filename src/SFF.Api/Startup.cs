...
namespace SFF.Api
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<SFFDbContext>(options =>
                options.UseSqlServer(Configuration.GetConnectionString("SFFDbContextConnection"), b => b.MigrationsAssembly("SFF.Api")));
